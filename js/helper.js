...
builder.getHelperText=function(dist,version){
	if(dist=="Ubuntu"||dist=="Debian"||dist=="Deepin"){
		...
		return "打开YaST点击Software分组中的Software Repositories，在打开的窗口上方的列表中点击openSUSE-"+version+"-Non-Oss，点击Edit将download.opensuse.org替换为mirrors.skyshe.cn/opensuse，点OK。再用同样的方法编辑openSUSE-"+version+"-Oss和openSUSE-"+version+"-Update";
	}else if(dist=="LinuxMint"){
		return "打开Software Manager，点击Edit⇒Software Sources，在Download from中选择Other，选择China#mirrors.skyshe.cn，点击Choose Server即可";
	}
}
